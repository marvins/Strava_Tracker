...
# Run Route Finder
./cpp/release/bin/route_finder -d ./bike_data.db -sector_id 1 -i 200 -pop 1000 -minw 6 -maxw 7 -nt 12 -start_point 39.6242729 -104.868715 -end_point 39.6451229 -104.869339
